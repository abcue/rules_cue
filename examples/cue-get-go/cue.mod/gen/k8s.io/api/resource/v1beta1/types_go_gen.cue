...
#ResourceSliceMaxDevicesWithTaintsOrConsumesCounters: 64
...
#BasicDevice: {
	...
	//
	// +optional
	capacity?: {[string]: #DeviceCapacity} @go(Capacity,map[QualifiedName]DeviceCapacity) @protobuf(2,bytes,rep)
	...
	// +featureGate=DRAPartitionableDevices
	// +k8s:maxItems=2
	consumesCounters?: [...#DeviceCounterConsumption] @go(ConsumesCounters,[]DeviceCounterConsumption) @protobuf(3,bytes,rep)
	...
	// +optional
	// +oneOf=DeviceNodeSelection
	nodeSelector?: null | v1.#NodeSelector @go(NodeSelector,*v1.NodeSelector) @protobuf(5,bytes,opt)
	...
	// +oneOf=DeviceNodeSelection
	// +featureGate=DRAPartitionableDevices
	allNodes?: null | bool @go(AllNodes,*bool) @protobuf(6,bytes,opt)
	...
	taints?: [...#DeviceTaint] @go(Taints,[]DeviceTaint) @protobuf(7,bytes,rep)
	...
	bindsToNode?: null | bool @go(BindsToNode,*bool) @protobuf(8,varint,opt)
	...
	// +k8s:optional
	// +k8s:maxItems=4
	bindingConditions?: [...string] @go(BindingConditions,[]string) @protobuf(9,bytes,rep)
	...
	// +k8s:optional
	// +k8s:maxItems=4
	bindingFailureConditions?: [...string] @go(BindingFailureConditions,[]string) @protobuf(10,bytes,rep)
	...
	allowMultipleAllocations?: null | bool @go(AllowMultipleAllocations,*bool) @protobuf(11,bytes,opt)
}
...
#DeviceRequest: {
	...
	adminAccess?: null | bool @go(AdminAccess,*bool) @protobuf(6,bytes,opt)
	...
	// +k8s:listMapKey=name
	// +k8s:maxItems=8
	firstAvailable?: [...#DeviceSubRequest] @go(FirstAvailable,[]DeviceSubRequest) @protobuf(7,bytes)
	...
	// +listType=atomic
	// +featureGate=DRADeviceTaints
	tolerations?: [...#DeviceToleration] @go(Tolerations,[]DeviceToleration) @protobuf(8,bytes,opt)
	...
	// +optional
	// +featureGate=DRAConsumableCapacity
	capacity?: null | #CapacityRequirements @go(Capacity,*CapacityRequirements) @protobuf(9,bytes,opt)
}
...
#DeviceSubRequest: {
	...
	// +listType=atomic
	// +featureGate=DRADeviceTaints
	tolerations?: [...#DeviceToleration] @go(Tolerations,[]DeviceToleration) @protobuf(7,bytes,opt)
	...
	// +optional
	// +featureGate=DRAConsumableCapacity
	capacity?: null | #CapacityRequirements @go(Capacity,*CapacityRequirements) @protobuf(8,bytes,opt)
}
