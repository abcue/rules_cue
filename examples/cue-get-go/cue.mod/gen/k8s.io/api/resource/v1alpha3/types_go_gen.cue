...
#DeviceTaintRule: {
	...
	//
	// +optional
	status?: #DeviceTaintRuleStatus @go(Status) @protobuf(3,bytes,opt)
}
...
#DeviceTaintRuleStatusMaxConditions: 8

#DeviceTaintConditionEvictionInProgress: "EvictionInProgress"
